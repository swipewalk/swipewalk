...
public static class DefaultRules
{
    ...
    [
        ...
        new("auto-updating-content", "Whether the screen kept changing on its own, with no input, across more than one interval between captures taken a few seconds apart (scan --auto-update-content; for review, since the content may not be shown alongside anything else, a control to pause/stop/hide it may exist somewhere on the screen, or the update may be essential to an activity)",
            [WcagCriteria.PauseStopHide]),
