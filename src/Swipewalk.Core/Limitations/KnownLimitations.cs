...
public static class KnownLimitations
{
    ...
    [
        ...
        new()
        {
            ...
            ManualCheck = "Swipe through with VoiceOver directly and compare by ear against the predicted transcript and whatever this route reported.",
