...
- **What:** Whether VoiceOver can reach an element is approximated from its type and label. Traits such as header and adjustable are not visible to the scanner.
...
- **What:** The predicted swipe order sorts elements top to bottom and left to right. Custom accessibilityElements ordering set by the app is not visible.
